...
import boto3
import logging
from urllib.parse import quote  # Removed unused urlparse
...
def upload_to_s3(
    file_path, s3_url, access_key, secret_key, bucket_name, region
):
    # Parse the S3 URL into bucket, region, and endpoint
    # bucket_name, region, endpoint_url = parse_s3_url(s3_url) # Commented out
